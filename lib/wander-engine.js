...
function furnish(group, type, cx, cz, w, d, ang0, M, H) {
  ...
  if (type==='living') {
    ...
    add(box(bw+0.2,0.18,1.5,M.duvet,0,0.58,back+1.25)); add(box(bw*0.42,0.14,0.4,M.linen,-bw*0.25,0.62,back+0.5)); add(box(bw*0.42,0.14,0.4,M.linen,bw*0.25,0.62,back+0.5));
    ...
    if (w>3.2) add(asset('wardrobe', right-0.35, 0.4, -Math.PI/2, {h:2.1}));
